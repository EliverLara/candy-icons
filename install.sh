...
*)
    ...
    -u)
        ...
        sleep 2s
        echo "Removing candy-icons..."
        rm -r $HOME/.local/share/icons/candy-icons-master/ && echo -e "\e[1;32mCandy-icon removed successfully\e[0m"
        echo ""
        ;;
    *)
        echo ""; echo -e "\e[1;36m   ///////     /////      ////    //  //////    //    //          ////////  ///////     ////////  ////    //\e[0m"
        ...
        sleep 2s
        echo "Extracting files..."
        tar -xjf ./Install/candy-icons-master.tar.gz

        # Copying candy-icons file
        sleep 2s
        echo "Candy-icons theme installation..."
        cp -r candy-icons-master/ $HOME/.local/share/icons/
        sleep 2s
